...
import (
	...
	"github.com/mahendraintelops/demo-project-v11/user-service/config"
	restcontrollers "github.com/mahendraintelops/demo-project-v11/user-service/pkg/rest/server/controllers"
	...
	"github.com/mahendraintelops/demo-project-v11/user-service/pkg/rest/client"
)
...
func main() {
	...
	bNodeE1, err0 := client.ExecuteNodeE1()
	if err0 != nil {
		log.Printf("error occurred: %v", err0)
		return
	}
	log.Printf("response received: %s", string(bNodeE1))
